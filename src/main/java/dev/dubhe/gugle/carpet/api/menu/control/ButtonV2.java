...
public class ButtonV2 {
    ...
    private final List<Consumer<ButtonV2>> turnOnCallback;
    private final List<Consumer<ButtonV2>> turnOffCallback;
    private boolean status;

    public ButtonV2(
        Container container, int slot,
        ItemStack on, ItemStack off,
        List<Consumer<ButtonV2>> turnOnCallback,
        List<Consumer<ButtonV2>> turnOffCallback,
        boolean status
    ) {
    ...
    public void callback() {
        List<Consumer<ButtonV2>> callbacks = this.status ? this.turnOnCallback : this.turnOffCallback;
        for (Consumer<ButtonV2> callback : callbacks) {
